...
declare type MutOk<T> = Mutable<Ok<T>>;
declare type MutErr<E> = Mutable<Err<E>>;
/**
 ...
 */
export declare function unsafeDropBothForResult<T, E>(v: Result<T, E>, okMutator: TapFn<MutOk<T>>, errMutator: TapFn<MutErr<E>>): void;
/**
 ...
 *  So if you call this for same object more than once, your code might contain "double free" problem.
 */
export declare function unsafeDropOkForResult<T, E>(v: Result<T, E>, okMutator: TapFn<MutOk<T>>): void;
/**
 ...
 *  So if you call this for same object more than once, your code might contain "double free" problem.
 */
export declare function unsafeDropErrForResult<T, E>(v: Result<T, E>, errMutator: TapFn<MutErr<E>>): void;
export {};
