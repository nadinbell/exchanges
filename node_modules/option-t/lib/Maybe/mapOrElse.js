 ...
 */
function mapOrElseForMaybe(src, def, selector) {
    var r;
    var msg = '';
    if (src !== undefined && src !== null) {
        r = selector(src);
        msg = ErrorMessage_1.ERR_MSG_SELECTOR_MUST_NOT_RETURN_NO_VAL_FOR_MAYBE;
    }
    else {
        r = def();
        msg = ErrorMessage_1.ERR_MSG_DEF_MUST_NOT_RETURN_NO_VAL_FOR_MAYBE;
    }
    return expect_1.expectNotNullAndUndefined(r, msg);
}
exports.mapOrElseForMaybe = mapOrElseForMaybe;
