...
import { ERR_MSG_SELECTOR_MUST_NOT_RETURN_NO_VAL_FOR_MAYBE, ERR_MSG_DEF_MUST_NOT_RETURN_NO_VAL_FOR_MAYBE, } from './ErrorMessage';
/**
 ...
 */
export function mapOrElseForMaybe(src, def, selector) {
    var r;
    var msg = '';
