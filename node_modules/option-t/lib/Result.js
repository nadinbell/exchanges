 ...
 */
function ResultBase(ok, val, err) {
  /**
   *  @private
   *  @type   {boolean}
   */
...
ResultBase.prototype = Object.freeze({
  ...
  ok: function ResultBaseOk() {
    if (this._isOk) {
      return (0, _Option.createSome)(this._v);
    } else {
      return (0, _Option.createNone)();
    }
  },
  ...
  err: function ResultBaseErr() {
    if (!this._isOk) {
      return (0, _Option.createSome)(this._e);
    } else {
      return (0, _Option.createNone)();
    }
  },
...
function createOk(v) {
  var o = new ResultBase(true, v, undefined);
  return o;
}
/**
 *  @deprecated
...
function createErr(e) {
  var o = new ResultBase(false, undefined, e);
  return o;
}