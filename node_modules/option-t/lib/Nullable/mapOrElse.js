 ...
 */
function mapOrElseForNullable(src, def, selector) {
    var r;
    var msg = '';
    if (src !== null) {
        r = selector(src);
        msg = ErrorMessage_1.ERR_MSG_SELECTOR_MUST_NOT_RETURN_NO_VAL_FOR_NULLABLE;
    }
    else {
        r = def();
        msg = ErrorMessage_1.ERR_MSG_DEF_MUST_NOT_RETURN_NO_VAL_FOR_NULLABLE;
    }
    return expect_1.expectNotNull(r, msg);
}
